...
from ..utils.metric import compute_exact, compute_f1
...
class Module(Base):
    ...
    def serialize_lang_action(self, feat):
        """append segmented instr language and low-level actions into single
        sequences."""
    ...
    def step(self, feat, prev_action=None):
        """forward the model for a single time-step (used for real-time
        execution during eval)"""
    ...
    def weighted_mask_loss(self, pred_masks, gt_masks):
        """mask loss that accounts for weight-imbalance between 0 and 1
        pixels."""
